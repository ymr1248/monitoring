...
<div id="page-wrapper">
    <div class="main-page">
        ...
        <div class="grid_3 grid_5 widget-shadow">
            <div>
                <h3>
                    <a href="toAddLowerOperator"><span class="label label-success">添加操作员</span></a>
                </h3>
            </div>
            <div>
                        ...
                        <c:forEach items="${list}" var="item" varStatus="status">
                            <tr class="manager-bg input-lg">
                                ...
                                <td class="manager-border2">
                                    <a href="toLowerOperatorUpdate?operatorId=${item.operatorId}&pageNum=${pageNum}">
                                        <span class="label label-success">修改</span></a>
                                    <c:choose>
                                        <c:when test="${list.size()==1}">
                                            <a href="deleteLowerOperator?operatorId=${item.operatorId}&pageNum=${pageNum-1}">
                                                <span class="label label-danger">删除</span></a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="deleteLowerOperator?operatorId=${item.operatorId}&pageNum=${pageNum}"><span
                ...
                <nav class="cbp-spmenu-right bbbb">
                    <ul class="pagination">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li><a href="higherOperatorManageLower?pageNum=1">首页</a></li>
                                <li>
                                    <a href="higherOperatorManageLower?pageNum=${pageNum-1}"
                                       aria-label="Previous">
                                        <span aria-hidden="true">«</span>
                                    </a>
                                </li>
                        ...
                        <c:forEach var="k" begin="1" end="${totalPage}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li>
                                        <a href="higherOperatorManageLower?pageNum=${k}">${k}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <a href="higherOperatorManageLower?pageNum=${pageNum+1}" aria-label="Next">
                                        <span aria-hidden="true">»</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="higherOperatorManageLower?pageNum=${totalPage}">尾页</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
