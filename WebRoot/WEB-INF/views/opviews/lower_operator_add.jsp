        ...
        <div class="tables">
            <div class="bs-example widget-shadow"
                ...
                <div class="row">
                    ...
                    <div class="form-body">
                        <form action="addLowerOperator" method="post" enctype="multipart/form-data"
                            ...
                            <div class=" form-group-lg">
                                ...
                                <input type="text" class="form-control" maxlength="16"
                                       id="operatorName" name="operatorName" placeholder="操作员名称" required>
                            </div>
                            <div class=" form-group-lg">
                            ...
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>账户：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="operatorAccount" name="operatorAccount" placeholder="账户" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>操作员地址：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="operatorAddress" name="operatorAddress" placeholder="操作员地址" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>操作员电话：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="operatorPhone" name="operatorPhone" placeholder="操作员电话" required>
                            </div>
                            ...
                            <select class="form-control" id="permission" name="permission" required>
                                ...
                                <c:forEach var="permission" items="${permissionType}">
                                    <c:if test="${permission.ordinal() > myPermission.ordinal()}">
