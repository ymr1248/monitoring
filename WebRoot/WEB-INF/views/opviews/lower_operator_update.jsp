        ...
        <div class="tables">
            <div class="bs-example widget-shadow"
                ...
                <div class="row">
                    ...
                    <div class="form-body">
                        <c:if test="${mOperator != null}">
                        <form action="updateLowerOperator" method="post" enctype="multipart/form-data"
                            ...
                            <div class=" form-group-lg">
                                ...
                                <input type="text" class="form-control" maxlength="16"
                                       id="operatorName" name="operatorName" value="${mOperator.operatorName}" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>操作员密码：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="password" name="password" value="${mOperator.password}" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>操作员地址：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="operatorAddress" name="operatorAddress" value="${mOperator.operatorAddress}" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>操作员电话：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="operatorPhone" name="operatorPhone" value="${mOperator.operatorPhone}" required>
                            </div>


                            <input type="text" class="hidden"
                                   id="permission" name="permission" value="${myPermission.permission}">
                            <input type="text" class="hidden"
                                   id="operatorId" name="operatorId" value="${mOperator.operatorId}">
                                <input type="text" class="hidden"
