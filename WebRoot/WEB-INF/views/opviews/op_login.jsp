...
<div  id="login">
    <div>
        ...
        <div class="login">
            <form action="opLogin" method="post" class="container offset1 loginform">

                <div class="pad">
                    <div class="control-group">
                        <div class="controls">
                            <label for="operatorAccount" class="control-label fa fa-user"></label>
                            <input id="operatorAccount" type="text" name="operatorAccount" maxlength="16" placeholder="账户" tabindex="1" required autofocus="autofocus" class="form-control input-medium">
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
