    ...
    <div class="main-page">
        ...
        <div class="grid_3 grid_5 widget-shadow">
            <div style="float: left;">
                <h3>
                    <a href="toOperator_monitorgroup_add"><span class="label label-success">添加监控器组</span></a>
                </h3>
            </div>
            <div style="float: left;margin-left: 25%">
            	<c:choose>
            		<c:when test="${search!=null }">
            			<form action="toOperator_monitorGroup_list" method="post">
                        ...
                        <tr>
                            ...
                            <tr class="manager-bg input-lg">
                                ...
                                <td class="manager-border2">
                                	<a href="toOperatorSeeMonitor?groupId=${item.groupId}&pageNum=1">
                                        <span class="label label-success">查看监控器</span></a>
                                    <a href="toOperatorMonitorgroup_update?id=${item.groupId}">
				...
				<nav class="cbp-spmenu-right bbbb">
                    <ul class="pagination">
                        <c:choose>
                            ...
                            <c:otherwise>
 								<li><a href="toOperator_monitorGroup_list?pageNum=1&search=${search}">首页</a></li>
                                <li>
                                    <a href="toOperator_monitorGroup_list?pageNum=${pageNum-1}&search=${search}"
                                       aria-label="Previous">
                                        <span aria-hidden="true">«</span>
                                    </a>
                                </li>
                        ...
                        <c:forEach var="k" begin="1" end="${totalPage}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li>
                                        <a href="toOperator_monitorGroup_list?pageNum=${k}&search=${search}">${k}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <a href="toOperator_monitorGroup_list?pageNum=${pageNum+1}&search=${search}" aria-label="Next">
                                        <span aria-hidden="true">»</span>
                                    </a>
                                </li>
                                <li>
                                	<a href="toOperator_monitorGroup_list?pageNum=${totalPage}&search=${search}">尾页</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
				...
				<nav class="cbp-spmenu-right bbbb">
                    <ul class="pagination">
                        <c:choose>
                            ...
                            <c:otherwise>
 								<li><a href="toOperator_monitorGroup_list?pageNum=1">首页</a></li>
                                <li>
                                    <a href="toOperator_monitorGroup_list?pageNum=${pageNum-1}"
                                       aria-label="Previous">
                                        <span aria-hidden="true">«</span>
                                    </a>
                                </li>
                        ...
                        <c:forEach var="k" begin="1" end="${totalPage}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li>
                                        <a href="toOperator_monitorGroup_list?pageNum=${k}">${k}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <a href="toOperator_monitorGroup_list?pageNum=${pageNum+1}" aria-label="Next">
                                        <span aria-hidden="true">»</span>
                                    </a>
                                </li>
                                <li>
                                	<a href="toOperator_monitorGroup_list?pageNum=${totalPage}">尾页</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
...
<script>
	...
	$("#only").click(function(){
		var newUrl = 'operator_monitorgroup_deleteOnly';
		$("#myForm").attr('action',newUrl);
		$("#myForm").submit();
	});
    
    $("#both").click(function(){
		var newUrl = 'operator_monitorgroup_deleteBoth';
		$("#myForm").attr('action',newUrl);
		$("#myForm").submit();
	});
