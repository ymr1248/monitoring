        ...
        <div class="grid_3 grid_5 widget-shadow">
            ...
            <div class="bs-example widget-shadow"
				...
				<div style="margin: 0 auto; width: 900px;height: 100px;font-size: 30px;text-align: center;">
					<a href="toShowHistoryVideo?pageNum=1&monitoringId=${monitoring.id}"><span class="label label-success">查看视频</span></a>
					<a href=""><span class="label label-success">截图</span></a>
					<a href="toOperatorUpdateMonitor?monitorId=${monitoring.id}"><span class="label label-success">修改信息</span></a>
					<a href="operatorDeleteMonitor?monitorId=${monitoring.id}&groupId=${monitoring.monitorGroup.groupId}"><span class="label label-danger">删除</span></a>
				</div>
