...
<div id="page-wrapper">
    <div class="main-page">
        ...
        <div class="grid_3 grid_5 widget-shadow">
            ...
            <div style="float: left;">
            	...
            	<c:choose>
            		<c:when test="${search!=null }">
            			<form action="toOperatorSeeMonitor" method="post">
            ...
            <a href="toOperatorSeeMonitor1?groupId=${groupId}&pageNum=1">批量操作</a>
            </span></div>
                 	...
                 	<c:otherwise>
						...
						<section class="section_class1">
							<div class="section_class1_div1">
								<a href="to_operator_monitor_info?id=${monitoring.id }">${monitoring.monitorName}</a>	
							</div>
				...
				<c:when test="${search!=null }">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li><a href="toOperatorSeeMonitor?pageNum=1&groupId=${groupId}&search=${search}">首页</a></li>
                                <li>
                                    <a href="toOperatorSeeMonitor?pageNum=${pageNum-1}&groupId=${groupId}&search=${search}"
                                       aria-label="Previous">
                                        <span aria-hidden="true">«</span>
                                    </a>
                                </li>
                        ...
                        <c:forEach var="k" begin="1" end="${totalPage}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li>
                                        <a href="toOperatorSeeMonitor?pageNum=${k}&groupId=${groupId}&search=${search}">${k}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <a href="toOperatorSeeMonitor?pageNum=${pageNum+1}&groupId=${groupId}&search=${search}" aria-label="Next">
                                        <span aria-hidden="true">»</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="toOperatorSeeMonitor?pageNum=${totalPage}&groupId=${groupId}&search=${search}">尾页</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
