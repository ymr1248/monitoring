        ...
        <div class="grid_3 grid_5 widget-shadow">
            <div class="form-title">
            	...
            	<c:when test="${startTime!=null && endTime!=null}">
            		<form action="toShowHistoryVideo" method="post">
				...
				<c:when test="${startTime!=null && endTime!=null}">
                    ...
                    <ul class="pagination">
                        <c:choose>
                            ...
                            <c:otherwise>
 								<li><a href="toShowHistoryVideo?pageNum=1&monitoringId=${monitoringId}&startTime=${startTime}&endTime=${endTime}">首页</a></li>
                                <li>
                                    <a href="toShowHistoryVideo?pageNum=${pageNum-1}&monitoringId=${monitoringId}&startTime=${startTime}&endTime=${endTime}"
                                       aria-label="Previous">
                                        <span aria-hidden="true">«</span>
                                    </a>
                                </li>
                        ...
                        <c:forEach var="k" begin="1" end="${totalPage}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li>
                                        <a href="toShowHistoryVideo?pageNum=${k}&monitoringId=${monitoringId}&startTime=${startTime}&endTime=${endTime}">${k}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <a href="toShowHistoryVideo?pageNum=${pageNum+1}&monitoringId=${monitoringId}&startTime=${startTime}&endTime=${endTime}" aria-label="Next">
                                        <span aria-hidden="true">»</span>
                                    </a>
                                </li>
                                <li>
                                	<a href="toShowHistoryVideo?pageNum=${totalPage}&monitoringId=${monitoringId}&startTime=${startTime}&endTime=${endTime}">尾页</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
				...
				<c:otherwise>
                    ...
                    <ul class="pagination">
                        <c:choose>
                            ...
                            <c:otherwise>
 								<li><a href="toShowHistoryVideo?pageNum=1&monitoringId=${monitoringId}">首页</a></li>
                                <li>
                                    <a href="toShowHistoryVideo?pageNum=${pageNum-1}&monitoringId=${monitoringId}"
                                       aria-label="Previous">
                                        <span aria-hidden="true">«</span>
                                    </a>
                                </li>
                        ...
                        <c:forEach var="k" begin="1" end="${totalPage}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li>
                                        <a href="toShowHistoryVideo?pageNum=${k}&monitoringId=${monitoringId}">${k}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <a href="toShowHistoryVideo?pageNum=${pageNum+1}&monitoringId=${monitoringId}" aria-label="Next">
                                        <span aria-hidden="true">»</span>
                                    </a>
                                </li>
                                <li>
                                	<a href="toShowHistoryVideo?pageNum=${totalPage}&monitoringId=${monitoringId}">尾页</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
