                        ...
                        <c:forEach items="${list}" var="item" varStatus="status">
                            ...
                            <tr class="manager-bg input-lg">
                                ...
                                <td class="manager-border2">
                                    <a href="changeUserRegistState?id=${item.id}&pageNum=${pageNum}&managerId=<%=managerId%>">
                                    ...
                                    <c:choose>
                                        <c:when test="${list.size()==(status.index+1) && status.index==0}">
                                            <a href="userDel?id=${item.id}&pageNum=${pageNum-1}&managerId=<%=managerId%>">
                                                <span class="label label-danger">不通过审核</span></a>
                                        </c:when>
                                        <c:otherwise>
                ...
                <nav class="cbp-spmenu-right bbbb">
                    <ul class="pagination">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li><a href="userRegisterList?pageNum=1">首页</a></li>
                                <li>
                                    <a href="userRegisterList?pageNum=${pageNum-1}"
                                       aria-label="Previous">
                                        <span aria-hidden="true">«</span>
                                    </a>
                                </li>
                        ...
                        <c:forEach var="k" begin="1" end="${totalPage}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li>
                                        <a href="userRegisterList?pageNum=${k}">${k}</a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <a href="userRegisterList?pageNum=${pageNum+1}" aria-label="Next">
                                        <span aria-hidden="true">»</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="userRegisterList?pageNum=${totalPage}">尾页</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
