            ...
            <div class="bs-example widget-shadow"
                ...
                <div class="row">
                    ...
                    <div class="form-body">
                        ...
                        <form action="operatorUpdate" method="post" enctype="multipart/form-data"
                              class="bs-example bs-example-form" role="form" name="touxiangform">
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>操作员名称：</label>
                                <input type="text" class="form-control" maxlength="16"
                                       id="operatorName" name="operatorName" value="${operator.operatorName}" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>操作员密码：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="password" name="password" value="${operator.password}" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>操作员地址：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="operatorAddress" name="operatorAddress" value="${operator.operatorAddress}" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>操作员电话：</label>
                                <input type="text" class="form-control" maxlength="100"
                                       id="operatorPhone" name="operatorPhone" value="${operator.operatorPhone}" required>
                            </div>
                            <label><i class="fa fa-user fa-fw"></i>操作员权限：</label>
                                <%-- <input type="text" class="form-control" maxlength="100"
                                        id="permission" name="permission" placeholder="操作员权限" required>--%>
                            <select class="form-control" id="permission" name="permission" required>
                                ...
                                <c:forEach var="permission" items="${permissionType}">
                            ...
                            <input type="text" class="hidden"
                                   id="operatorId" name="operatorId" value="${operator.operatorId}">
                            <%--<input type="text" class="hidden"
