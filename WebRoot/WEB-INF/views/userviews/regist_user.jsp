                        ...
                        <form action="registerUser" method="post" enctype="multipart/form-data"
                            ...
                            <div class=" form-group-lg">
                                ...
                                <input type="text" class="form-control" maxlength="100"
                                       id="account" name="account" placeholder="用户账号" required>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>用户密码：</label>
                                <input type="text" class="form-control" maxlength="16"
                                       id="password" name="password" placeholder="用户密码"/>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>用户地址：</label>
                                <input type="text" class="form-control" maxlength="16"
                                       id="userAddress" name="userAddress" placeholder="用户地址"/>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>用户电话：</label>
                                <input type="text" class="form-control" maxlength="16"
                                       id="userPhone" name="userPhone" placeholder="用户电话"/>
                            </div>
                            <div class=" form-group-lg">
                                <label><i class="fa fa-user fa-fw"></i>用户邮箱：</label>
                                <input type="text" class="form-control" maxlength="16"
                                       id="userEMail" name="userEmail" placeholder="用户邮箱"/>
                            </div>
