...
<c:forEach items="${monitorGroupList}" var="monitorGroup">

<div class="section_class_title" onclick="monitoring_click(${monitorGroup.groupId})">
	<span>
		${monitorGroup.groupName}
	</span>
	<img src="images/left.png" id="img_${monitorGroup.groupId}">
</div>
<div class="space_div"></div>
<section class="section_class" id="section_${status.index}">
</section>

<%-- <div id="insert_${monitorGroup.groupId}" class="insert_here">
</div> --%>
<%--<section class="section_class" id="section_${status.index}">
